...
const InputText: React.FC<IInputTextProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center bg-gray-100  py-1 rounded-lg h-10 focus-within:bg-gray-50 w-full`}
      >
        <input
          ...
          className={`px-2 py-1  bg-gray-100 text-gray-700 rounded-lg w-full h-10 text-sm focus:bg-gray-50 outline-none ring-0 outline-white border-transparent focus:border-transparent focus:ring-0 focus:outline-transparent`}
        />
      </div>
      {isError && (
